...
def u_net_bn(x, is_train=False, reuse=False, batch_size=None, pad='SAME', n_out=1):
    ...
    with tf.variable_scope("u_net", reuse=reuse):
        ...
        batch1 = BatchNormLayer(conv1, is_train=is_train, 
                        act=tf.nn.leaky_relu, gamma_init=gamma_init, name='bn1_1')
        conv1 = Conv2d(batch1, 64, (3, 3), 
                        act=tf.nn.leaky_relu, padding='SAME', W_init=w_init, b_init=b_init, name='conv1_2')
        batch1 = BatchNormLayer(conv1, is_train=is_train, 
                        act=tf.nn.leaky_relu, gamma_init=gamma_init, name='bn1_2')
        ...
        batch2 = BatchNormLayer(conv2, is_train=is_train, 
                        act=tf.nn.leaky_relu, gamma_init=gamma_init, name='bn2_1')
        conv2 = Conv2d(batch2, 128, (3, 3),
                       act=tf.nn.leaky_relu, padding='SAME', W_init=w_init, b_init=b_init, name='conv2_2')
        batch2 = BatchNormLayer(conv2, is_train=is_train, 
                        act=tf.nn.leaky_relu, gamma_init=gamma_init, name='bn2_2')
        ...
        batch3 = BatchNormLayer(conv3, is_train=is_train, 
                        act=tf.nn.leaky_relu, gamma_init=gamma_init, name='bn3_1')
        conv3 = Conv2d(batch3, 256, (3, 3),
                       act=tf.nn.leaky_relu, padding='SAME', W_init=w_init, b_init=b_init, name='conv3_2')
        batch3 = BatchNormLayer(conv3, is_train=is_train, 
                        act=tf.nn.leaky_relu, gamma_init=gamma_init, name='bn3_2')
        ...
        batch4 = BatchNormLayer(conv4, is_train=is_train, 
                        act=tf.nn.leaky_relu, gamma_init=gamma_init, name='bn4_1')
        conv4 = Conv2d(batch4, 512, (3, 3),
                       act=tf.nn.leaky_relu, padding='SAME', W_init=w_init, b_init=b_init, name='conv4_2')
        batch4 = BatchNormLayer(conv4, is_train=is_train, 
                        act=tf.nn.leaky_relu, gamma_init=gamma_init, name='bn4_2')
        ...
        batch5 = BatchNormLayer(conv5, is_train=is_train, 
                        act=tf.nn.leaky_relu, gamma_init=gamma_init, name='bn5_1')
        conv5 = Conv2d(batch5, 1024, (3, 3),
                       act=tf.nn.leaky_relu, padding='SAME', W_init=w_init, b_init=b_init, name='conv5_2')
        batch5 = BatchNormLayer(conv5, is_train=is_train, 
                        act=tf.nn.leaky_relu, gamma_init=gamma_init, name='bn5_2')
        #Layer 5
        ...
        batch4 = BatchNormLayer(conv4, is_train=is_train, 
                    act=tf.nn.leaky_relu, gamma_init=gamma_init, name='ubn4_1')
        conv4 = Conv2d(batch4, 512, (3, 3),
                    act=tf.nn.leaky_relu, padding='SAME', W_init=w_init, b_init=b_init, name='uconv4_2')
        batch4 = BatchNormLayer(conv4, is_train=is_train, 
                    act=tf.nn.leaky_relu, gamma_init=gamma_init, name='ubn4_2')
        #Up Layer 4
        ...
        batch3 = BatchNormLayer(conv3, is_train=is_train, 
                    act=tf.nn.leaky_relu, gamma_init=gamma_init, name='ubn3_1')
        conv3 = Conv2d(batch3, 256, (3, 3),
                    act=tf.nn.leaky_relu, padding='SAME', W_init=w_init, b_init=b_init, name='uconv3_2')
        batch3 = BatchNormLayer(conv3, is_train=is_train, 
                    act=tf.nn.leaky_relu, gamma_init=gamma_init, name='ubn3_2')
        #Up Layer 3
        ...
        batch2 = BatchNormLayer(conv2, is_train=is_train, 
                        act=tf.nn.leaky_relu, gamma_init=gamma_init, name='ubn2_1')
        conv2 = Conv2d(batch2, 128, (3, 3),
                        act=tf.nn.leaky_relu, padding='SAME', W_init=w_init, b_init=b_init, name='uconv2_2')
        batch2 = BatchNormLayer(conv2, is_train=is_train, 
                        act=tf.nn.leaky_relu, gamma_init=gamma_init, name='ubn2_2')
        #Up Layer 2
        ...
        batch1 = BatchNormLayer(conv1, is_train=is_train, 
                    act=tf.nn.leaky_relu, gamma_init=gamma_init, name='ubn1_1')
        conv1 = Conv2d(batch1, 64, (3, 3),
                    act=tf.nn.leaky_relu, padding='SAME', W_init=w_init, b_init=b_init, name='uconv1_2')
        batch1 = BatchNormLayer(conv1, is_train=is_train, 
                    act=tf.nn.leaky_relu, gamma_init=gamma_init, name='ubn1_2')
        #Up Layer 1
