...
def u_net(x, is_train=False, reuse=False, n_out=1):
    ...
    with tf.variable_scope("u_net", reuse=reuse):
        ...
        conv1 = Conv2d(inputs, 64, (3, 3),
                       act=tf.nn.leaky_relu, name='conv1_1')
        ...
        conv2 = Conv2d(pool1, 128, (3, 3),
                       act=tf.nn.leaky_relu, name='conv2_1')
        conv2 = Conv2d(conv2, 128, (3, 3),
                       act=tf.nn.leaky_relu, name='conv2_2')
        pool2 = MaxPool2d(conv2, (2, 2), name='pool2')

        conv3 = Conv2d(pool2, 256, (3, 3),
                       act=tf.nn.leaky_relu, name='conv3_1')
        conv3 = Conv2d(conv3, 256, (3, 3),
                       act=tf.nn.leaky_relu, name='conv3_2')
        pool3 = MaxPool2d(conv3, (2, 2), name='pool3')

        conv4 = Conv2d(pool3, 512, (3, 3),
                       act=tf.nn.leaky_relu, name='conv4_1')
        conv4 = Conv2d(conv4, 512, (3, 3),
                       act=tf.nn.leaky_relu, name='conv4_2')
        pool4 = MaxPool2d(conv4, (2, 2), name='pool4')

        conv5 = Conv2d(pool4, 1024, (3, 3),
                       act=tf.nn.leaky_relu, name='conv5_1')
        conv5 = Conv2d(conv5, 1024, (3, 3),
                       act=tf.nn.leaky_relu, name='conv5_2')

        up4 = DeConv2d(conv5, 512, (3, 3), (nx/8, ny/8),
                       (2, 2), name='deconv4')
        up4 = ConcatLayer([up4, conv4], 3, name='concat4')
        conv4 = Conv2d(up4, 512, (3, 3), act=tf.nn.leaky_relu, name='uconv4_1')
        conv4 = Conv2d(conv4, 512, (3, 3),
                       act=tf.nn.leaky_relu, name='uconv4_2')

        up3 = DeConv2d(conv4, 256, (3, 3), (nx/4, ny/4),
                       (2, 2), name='deconv3')
        up3 = ConcatLayer([up3, conv3], 3, name='concat3')
        conv3 = Conv2d(up3, 256, (3, 3), act=tf.nn.leaky_relu, name='uconv3_1')
        conv3 = Conv2d(conv3, 256, (3, 3),
                       act=tf.nn.leaky_relu, name='uconv3_2')

        up2 = DeConv2d(conv3, 128, (3, 3), (nx/2, ny/2),
                       (2, 2), name='deconv2')
        up2 = ConcatLayer([up2, conv2], 3, name='concat2')
        conv2 = Conv2d(up2, 128, (3, 3),
                       act=tf.nn.leaky_relu,  name='uconv2_1')
        conv2 = Conv2d(conv2, 128, (3, 3),
...
def u_net_bn_relu(x, is_train=False, reuse=False, batch_size=None, pad='SAME', n_out=1):
    ...
    with tf.variable_scope("u_net", reuse=reuse):
        ...
        conv1 = Conv2d(inputs, 64, (3, 3), (2, 2), act=None,
                       padding=pad, W_init=w_init, b_init=b_init, name='conv1')
        conv2 = Conv2d(conv1, 128, (3, 3), (2, 2), act=None,
                       padding=pad, W_init=w_init, b_init=b_init, name='conv2')
        conv2 = BatchNormLayer(conv2, act=tf.nn.relu, is_train=is_train, gamma_init=gamma_init, name='bn2')

        conv3 = Conv2d(conv2, 256, (3, 3), (2, 2), act=None,
                       padding=pad, W_init=w_init, b_init=b_init, name='conv3')
        conv3 = BatchNormLayer(conv3, act=tf.nn.relu, is_train=is_train, gamma_init=gamma_init, name='bn3')

        conv4 = Conv2d(conv3, 512, (3, 3), (2, 2), act=None,
                       padding=pad, W_init=w_init, b_init=b_init, name='conv4')
        conv4 = BatchNormLayer(conv4, act=tf.nn.relu, is_train=is_train, gamma_init=gamma_init, name='bn4')

        conv5 = Conv2d(conv4, 512, (3, 3), (2, 2), act=None,
                       padding=pad, W_init=w_init, b_init=b_init, name='conv5')
        conv5 = BatchNormLayer(conv5, act=tf.nn.relu, is_train=is_train, gamma_init=gamma_init, name='bn5')

        conv6 = Conv2d(conv5, 512, (3, 3), (2, 2), act=None,
                       padding=pad, W_init=w_init, b_init=b_init, name='conv6')
        conv6 = BatchNormLayer(conv6, act=tf.nn.relu, is_train=is_train, gamma_init=gamma_init, name='bn6')

        conv7 = Conv2d(conv6, 512, (3, 3), (2, 2), act=None,
                       padding=pad, W_init=w_init, b_init=b_init, name='conv7')
        conv7 = BatchNormLayer(conv7, act=tf.nn.relu, is_train=is_train, gamma_init=gamma_init, name='bn7')

        conv8 = Conv2d(conv7, 512, (3, 3), (2, 2), act=tf.nn.relu, padding=pad, W_init=w_init, b_init=b_init, name='conv8')
        # print(" * After conv: %s" % conv8.outputs)
        # exit()
        # print(nx/8)
        up7 = DeConv2d(conv8, 512, (3, 3), out_size=(2, 2), strides=(2, 2),
        ...
        up6 = DeConv2d(up6, 1024, (3, 3), out_size=(4, 4), strides=(2, 2),
                       padding=pad, act=None, batch_size=batch_size, W_init=w_init, b_init=b_init, name='deconv6')
        up6=BatchNormLayer(
            up6, act=tf.nn.relu, is_train=is_train, gamma_init=gamma_init, name='dbn6')
        # print(up6.outputs)
        # exit()
...
def u_net_bn(x, is_train=False, reuse=False, batch_size=None, pad='SAME', n_out=1):
    ...
    with tf.variable_scope("u_net", reuse=reuse):
        ...
        # Layer 1
        conv1 = Conv2d(inputs, 64, (3, 3), (2, 2), act=None,
                       padding=pad, W_init=w_init, b_init=b_init, name='conv1_1')
        bn1 = BatchNormLayer(conv1, act=tf.nn.leaky_relu, is_train=is_train, gamma_init=gamma_init, name='bn1_1')
        conv1_2 = Conv2d(bn1, 64, (3, 3), (2, 2), act=None,
                       padding=pad, W_init=w_init, b_init=b_init, name='conv1_2')
        bn1_2 = BatchNormLayer(conv1_2, act=tf.nn.leaky_relu, is_train=is_train, gamma_init=gamma_init, name='bn1_2')
        pool1 = MaxPool2d(bn1_2, (2, 2), name='pool1')
        # End Layer 1

        # Layer 2
        conv2 = Conv2d(pool1, 128, (3, 3), (2, 2), act=None,
                       padding=pad, W_init=w_init, b_init=b_init, name='conv2_1')
        bn2 = BatchNormLayer(conv2, act=tf.nn.leaky_relu, is_train=is_train, gamma_init=gamma_init, name='bn2_1')
        conv2_2 = Conv2d(bn2, 128, (3, 3), (2, 2), act=None,
                       padding=pad, W_init=w_init, b_init=b_init, name='conv2_2')
        bn2_2 = BatchNormLayer(conv2_2, act=tf.nn.leaky_relu, is_train=is_train, gamma_init=gamma_init, name='bn2_2')
        pool2 = MaxPool2d(bn2_2, (2, 2), name='pool2')
        # End Layer 2

        # Layer 3
        conv3 = Conv2d(pool2, 256, (3, 3), (2, 2), act=None,
                       padding=pad, W_init=w_init, b_init=b_init, name='conv3_1')
        bn3 = BatchNormLayer(conv3, act=tf.nn.leaky_relu, is_train=is_train, gamma_init=gamma_init, name='bn3_1')
        conv3_2 = Conv2d(bn3, 256, (3, 3), (2, 2), act=None,
                       padding=pad, W_init=w_init, b_init=b_init, name='conv3_2')
        bn3_2 = BatchNormLayer(conv3_2, act=tf.nn.leaky_relu, is_train=is_train, gamma_init=gamma_init, name='bn3_2')
        pool3 = MaxPool2d(bn3_2, (2, 2), name='pool3')
        # End Layer 3

        # Layer 4
        conv4 = Conv2d(pool3, 512, (3, 3), (2, 2), act=None,
                       padding=pad, W_init=w_init, b_init=b_init, name='conv4_1')
        bn4 = BatchNormLayer(conv4, act=tf.nn.leaky_relu, is_train=is_train, gamma_init=gamma_init, name='bn4_1')
        conv4_2 = Conv2d(bn4, 512, (3, 3), (2, 2), act=None,
                       padding=pad, W_init=w_init, b_init=b_init, name='conv4_2')
        bn4_2 = BatchNormLayer(conv4_2, act=tf.nn.leaky_relu, is_train=is_train, gamma_init=gamma_init, name='bn4_2')
        pool4 = MaxPool2d(bn4_2, (2, 2), name='pool4')
        # End Layer 4

        # Layer 5
        conv5 = Conv2d(pool4, 1024, (3, 3), (2, 2), act=None,
                       padding=pad, W_init=w_init, b_init=b_init, name='conv5_1')
        bn5 = BatchNormLayer(conv5, act=tf.nn.leaky_relu, is_train=is_train, gamma_init=gamma_init, name='bn5_1')
        conv5_2 = Conv2d(bn5, 1024, (3, 3), (2, 2), act=None,
                       padding=pad, W_init=w_init, b_init=b_init, name='conv5_2')
        bn5_2 = BatchNormLayer(conv5_2, act=tf.nn.leaky_relu, is_train=is_train, gamma_init=gamma_init, name='bn5_2')
        #pool5 = MaxPool2d(bn5_2, (2, 2), name='pool5')
        # End Layer 5

        #Layer 6 (3,3) -> (2,2)
        up6 = DeConv2d(bn5_2, 512, (3, 3), out_size=(2, 2), strides=(2, 2),
                       padding=pad, act=None, batch_size=batch_size, W_init=w_init, b_init=b_init, name='deconv6_1')
        concat1 = ConcatLayer([up6, bn4_2], concat_dim=3, name='concat6')
        conv6 = Conv2d(concat1, 512, (3, 3), (2, 2), act=None,
                       padding=pad, W_init=w_init, b_init=b_init, name='conv6_1')
        bn6 = BatchNormLayer(conv6, act=tf.nn.leaky_relu, is_train=is_train, gamma_init=gamma_init, name='bn6_1')
        conv6_2 = Conv2d(bn6, 512, (3, 3), (2, 2), act=None,
                       padding=pad, W_init=w_init, b_init=b_init, name='conv6_2')
        bn6_2 = BatchNormLayer(conv6_2, act=tf.nn.leaky_relu, is_train=is_train, gamma_init=gamma_init, name='bn6_2')
        #End Layer 6

        #Layer 7 (3,3) -> (2,2)
        up7 = DeConv2d(bn6_2, 256, (3, 3), out_size=(2, 2), strides=(2, 2),
                       padding=pad, act=None, batch_size=batch_size, W_init=w_init, b_init=b_init, name='deconv7_1')
        concat2 = ConcatLayer([up7, bn3_2], concat_dim=3, name='concat7')
        conv7 = Conv2d(concat2, 256, (3, 3), (2, 2), act=None,
                       padding=pad, W_init=w_init, b_init=b_init, name='conv7_1')
        bn7 = BatchNormLayer(conv7, act=tf.nn.leaky_relu, is_train=is_train, gamma_init=gamma_init, name='bn7_1')
        conv7_2 = Conv2d(bn7, 256, (3, 3), (2, 2), act=None,
                       padding=pad, W_init=w_init, b_init=b_init, name='conv7_2')
        bn7_2 = BatchNormLayer(conv7_2, act=tf.nn.leaky_relu, is_train=is_train, gamma_init=gamma_init, name='bn7_2')
        #End Layer 7

        #Layer 8 (3,3) -> (2,2)
        up8 = DeConv2d(bn7_2, 128, (3, 3), out_size=(2, 2), strides=(2, 2),
                       padding=pad, act=None, batch_size=batch_size, W_init=w_init, b_init=b_init, name='deconv8_1')
        concat3 = ConcatLayer([up8, bn2_2], concat_dim=3, name='concat8')
        conv8 = Conv2d(concat3, 128, (3, 3), (2, 2), act=None,
        ...
        conv8_2 = Conv2d(bn8, 128, (3, 3), (2, 2), act=None,
        ...
        up9 = DeConv2d(bn8_2, 64, (3, 3), out_size=(2, 2), strides=(2, 2),
                       padding=pad, act=None, batch_size=batch_size, W_init=w_init, b_init=b_init, name='deconv9_1')
        concat4 = ConcatLayer([up9, bn1_2], concat_dim=3, name='concat9')
        conv9 = Conv2d(concat4, 64, (3, 3), (2, 2), act=None,
                       padding=pad, W_init=w_init, b_init=b_init, name='conv9_1')
        bn9 = BatchNormLayer(conv9, act=tf.nn.leaky_relu, is_train=is_train, gamma_init=gamma_init, name='bn9_1')
        conv9_2 = Conv2d(bn9, 64, (3, 3), (2, 2), act=None,
                       padding=pad, W_init=w_init, b_init=b_init, name='conv9_2')
        bn9_2 = BatchNormLayer(conv9_2, act=tf.nn.leaky_relu, is_train=is_train, gamma_init=gamma_init, name='bn9_2')
        #End Layer 9

        out = Conv2d(bn9_2, n_out, (1, 1), act=tf.nn.sigmoid, name='out')
...
def u_net_bn_old(x, is_train=False, reuse=False, batch_size=None, pad='SAME', n_out=1):
    ...
    with tf.variable_scope("u_net", reuse=reuse):
        ...
        conv8 = Conv2d(conv7, 512, (3, 3), (2, 2), act=tf.nn.leaky_relu, padding=pad, W_init=w_init, b_init=b_init, name='conv8')
        # print(" * After conv: %s" % conv8.outputs)
        # exit()
        # print(nx/8)
        up7 = DeConv2d(conv8, 512, (3, 3), out_size=(2, 2), strides=(2, 2),
                       padding=pad, act=None, batch_size=batch_size, W_init=w_init, b_init=b_init, name='deconv7')
        up7 = BatchNormLayer(
            up7, act=tf.nn.leaky_relu, is_train=is_train, gamma_init=gamma_init, name='dbn7')
        ...
        up6 = DeConv2d(up6, 1024, (3, 3), out_size=(4, 4), strides=(2, 2),
                       padding=pad, act=None, batch_size=batch_size, W_init=w_init, b_init=b_init, name='deconv6')
        up6=BatchNormLayer(
            up6, act=tf.nn.leaky_relu, is_train=is_train, gamma_init=gamma_init, name='dbn6')
        # print(up6.outputs)
        # exit()
        ...
        up5=DeConv2d(up5, 1024, (3, 3), out_size=(8, 8), strides=(2, 2),
                       padding=pad, act=None, batch_size=batch_size, W_init=w_init, b_init=b_init, name='deconv5')
        up5=BatchNormLayer(
            up5, act=tf.nn.leaky_relu, is_train=is_train, gamma_init=gamma_init, name='dbn5')
        # print(up5.outputs)
        # exit()
        ...
        up4=DeConv2d(up4, 1024, (3, 3), out_size=(15, 15), strides=(2, 2),
                       padding=pad, act=None, batch_size=batch_size, W_init=w_init, b_init=b_init, name='deconv4')
        up4=BatchNormLayer(
            up4, act=tf.nn.leaky_relu, is_train=is_train, gamma_init=gamma_init, name='dbn4')

        up3=ConcatLayer([up4, conv4], concat_dim=3, name='concat3')
        up3=DeConv2d(up3, 256, (3, 3), out_size=(30, 30), strides=(2, 2),
                       padding=pad, act=None, batch_size=batch_size, W_init=w_init, b_init=b_init, name='deconv3')
        up3=BatchNormLayer(
            up3, act=tf.nn.leaky_relu, is_train=is_train, gamma_init=gamma_init, name='dbn3')

        up2=ConcatLayer([up3, conv3], concat_dim=3, name='concat2')
        up2=DeConv2d(up2, 128, (3, 3), out_size=(60, 60), strides=(2, 2),
                       padding=pad, act=None, batch_size=batch_size, W_init=w_init, b_init=b_init, name='deconv2')
        up2=BatchNormLayer(
            up2, act=tf.nn.leaky_relu, is_train=is_train, gamma_init=gamma_init, name='dbn2')

        up1=ConcatLayer([up2, conv2], concat_dim=3, name='concat1')
        up1=DeConv2d(up1, 64, (3, 3), out_size=(120, 120), strides=(2, 2),
                       padding=pad, act=None, batch_size=batch_size, W_init=w_init, b_init=b_init, name='deconv1')
        up1=BatchNormLayer(
            up1, act=tf.nn.leaky_relu, is_train=is_train, gamma_init=gamma_init, name='dbn1')

        up0=ConcatLayer([up1, conv1], concat_dim=3, name='concat0')
        up0=DeConv2d(up0, 64, (3, 3), out_size=(240, 240), strides=(2, 2),
                       padding=pad, act=None, batch_size=batch_size, W_init=w_init, b_init=b_init, name='deconv0')
        up0=BatchNormLayer(
            up0, act=tf.nn.leaky_relu, is_train=is_train, gamma_init=gamma_init, name='dbn0')
        # print(up0.outputs)
        # exit()
