...
def u_net_bn(x, is_train=False, reuse=False, batch_size=None, pad='SAME', n_out=1):
    ...
    with tf.variable_scope("u_net", reuse=reuse):
        ...
        #Layer 7 (3,3) -> (2,2)
        up7 = DeConv2d(conv6, 256, (3, 3), (nx/4, nx/4), strides=(2, 2),
        ...
        #Layer 8 (3,3) -> (2,2)
        up8 = DeConv2d(conv7, 128, (3, 3), (nx/2, nx/2), strides=(2, 2),
        ...
        conv8 = Conv2d(conv8, 128, (3, 3), (2, 2), act=tf.nn.leaky_relu,
        ...
        #Layer 9 (3,3) -> (2,2)
        up9 = DeConv2d(conv8, 64, (3, 3), (nx/1, nx/1), strides=(2, 2),
