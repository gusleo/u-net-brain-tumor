...
def u_net_bn(x, is_train=False, reuse=False, batch_size=None, pad='SAME', n_out=1):
    ...
    with tf.variable_scope("u_net", reuse=reuse):
        ...
        conv1 = Conv2d(inputs, 64, (4, 4), (2, 2), act=None,
                       padding=pad, W_init=w_init, b_init=b_init, name='conv1')
        conv2 = Conv2d(conv1, 128, (4, 4), (2, 2), act=None,
        ...
        conv3 = Conv2d(conv2, 256, (4, 4), (2, 2), act=None,
        ...
        conv4 = Conv2d(conv3, 512, (4, 4), (2, 2), act=None,
        ...
        conv5 = Conv2d(conv4, 512, (4, 4), (2, 2), act=None,
        ...
        conv6 = Conv2d(conv5, 512, (4, 4), (2, 2), act=None,
        ...
        conv7 = Conv2d(conv6, 512, (4, 4), (2, 2), act=None,
        ...
        conv8 = Conv2d(conv7, 512, (4, 4), (2, 2), act=lambda x: tl.act.lrelu(
