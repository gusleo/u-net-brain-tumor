...
def u_net_bn(x, is_train=False, reuse=False, batch_size=None, pad='SAME', n_out=1):
    ...
    with tf.variable_scope("u_net", reuse=reuse):
        ...
        concat1 = ConcatLayer([up6, pool4], concat_dim=3, name='concat6')
        ...
        #Layer 7 (3,3) -> (2,2)
        up7 = DeConv2d(conv6, 256, (3, 3), out_size=(2, 2), strides=(2, 2),
        ...
        #Layer 8 (3,3) -> (2,2)
        up8 = DeConv2d(conv7, 128, (3, 3), out_size=(2, 2), strides=(2, 2),
        ...
        #Layer 9 (3,3) -> (2,2)
        up9 = DeConv2d(conv8, 64, (3, 3), out_size=(2, 2), strides=(2, 2),
