...
def u_net_bn(x, is_train=False, reuse=False, batch_size=None, pad='SAME', n_out=1):
    ...
    with tf.variable_scope("u_net", reuse=reuse):
        ...
        batch1 = BatchNormLayer(conv1, act=lambda x : tl.act.linier(x), 
        ...
        batch4 = BatchNormLayer(conv4, act=lambda x : tl.act.linier(x), 
        ...
        batch5 = BatchNormLayer(conv5, act=lambda x : tl.act.linier(x), 
